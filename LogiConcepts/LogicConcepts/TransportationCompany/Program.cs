...
do
{
    ...
    // Calculations
    var incomePassangers = GetIncomePassageers(route, passangers, trips);
    ...
    var valueAssurrace = GetValueAsurrace(incomes);
...
decimal GetValueAsurrace(decimal incomes)
{
...
decimal GetIncomePassageers(string? route, int passangers, int trips)
{
    ...
    switch (route)
    {
        ...
        default:
            ...
            return value * 1.17m + (passangers - 2000) * 150m;
    };
